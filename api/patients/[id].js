...
const connectDB = async () => {
  ...
  try {
    ...
    console.log('🔍 Connecting to MongoDB for patient endpoint...');
    ...
    isConnected = true;
    console.log('✅ MongoDB Connected Successfully for patient endpoint!');
  } catch (error) {
    console.error('❌ MongoDB Connection Failed for patient endpoint:', error.message);
    isConnected = false;
    throw error;
  }
};
